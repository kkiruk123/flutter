...
class ShoppingCartDetail extends StatelessWidget {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            _buildDetailNameAndPrice(context),
            _buildDetailRatingAndReviewCount(),
            _buildDetailColorOptions(context),
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Text(
            "\$${priceList[idProviderData.selectedId]}",
            style: TextStyle(
              fontSize: 18,
              fontWeight: FontWeight.bold,
            ),
  ...
  Widget _buildDetailColorOptions(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(bottom: 20),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          ...
          Row(
            children: [
              ...
              _buildDetailIcon(0, Colors.black, context),
              _buildDetailIcon(1, Colors.green, context),
              _buildDetailIcon(2, Colors.orange, context),
              _buildDetailIcon(3, Colors.grey, context),
              _buildDetailIcon(4, Colors.white, context),
            ],
          ),
        ],
      ),
  ...
  Widget _buildDetailIcon(int id, Color mColor, BuildContext context) {
    return Padding(
